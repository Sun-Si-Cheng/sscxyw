        ...
        if ($stmt->fetch()) {
            ...
            if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] === UPLOAD_ERR_OK) {
                ...
                if (!in_array($file['type'], ALLOWED_IMAGE_TYPES)) {
                    ...
                    $avatar = uniqid() . '.' . $ext;
                    $uploadPath = __DIR__ . '/uploads/avatars/' . $avatar;
                    
                    if (move_uploaded_file($file['tmp_name'], $uploadPath)) {
                        // 删除旧头像（如果不是默认头像）
                        if ($currentUser['avatar'] !== 'default_avatar.png') {
        ...
        <div class="profile-sidebar">
            <div class="profile-card">
                <div class="profile-avatar-wrapper">
                    <img src="uploads/avatars/<?php echo $currentUser['avatar']; ?>" alt="<?php echo clean($currentUser['nickname'] ?: $currentUser['username']); ?>" class="profile-avatar-lg">
                </div>
                ...
                <form method="POST" action="" enctype="multipart/form-data" class="profile-form">
                    <div class="form-group">
                        ...
                        <div class="avatar-upload">
                            <img src="uploads/avatars/<?php echo $currentUser['avatar']; ?>" alt="当前头像" id="avatar-preview">
